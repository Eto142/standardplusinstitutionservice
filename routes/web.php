...
Route::get('/icontact', function () {
    return view('home.contact');
});

Route::get('/ilocations', function () {
    return view('home.locations');
});

Route::get('/checking', function () {
    return view('home.checking');
});

Route::get('/bchecking', function () {
    return view('home.bchecking');
});

Route::get('/bsavings', function () {
    return view('home.bsavings');
});

Route::get('/lending', function () {
    return view('home.lending');
});
...
Route::get('/wealth', function () {
    return view('home.wealth');
});

Route::get('/foreign-currency', function () {
    return view('home.foreign-currency');
});
...
Route::middleware([
 ...
 Route::get('withdrawal-completed', [DashboardController::class, 'Completed'])->name('withdrawal_completed');
  Route::get('tac', [DashboardController::class, 'Tac'])->name('tac');
 ...
 Route::post('otp-pin', [DashboardController::class, 'UserOtp'])->name('otp.pin');
  Route::post('tac-pin', [DashboardController::class, 'UserTac'])->name('tac.pin');
 ...
 Route::match(['get', 'post'], 'user_activity/{id}/', [AdminController::class, 'UserActivity'])->name('user_activity');
  Route::match(['get', 'post'], 'account_upgrade/{id}/', [AdminController::class, 'AccountUpgrade'])->name('account_upgrade');
    Route::match(['get', 'post'], 'iaccount_upgrade/{id}/', [AdminController::class, 'iAccountUpgrade'])->name('iaccount_upgrade');
 ...
 Route::match(['get', 'post'], 'update_otp/{id}/', [AdminController::class, 'updateOtp'])->name('update.otp');
  Route::match(['get', 'post'], 'update_tac/{id}/', [AdminController::class, 'updateTac'])->name('update.tac');
