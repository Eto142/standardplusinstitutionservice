...
class CreateNewUser implements CreatesNewUsers
{
    ...
    public function create(array $input)
    {
        Validator::make($input, [
            ...
            'kin_email' => ['required', 'string', 'max:255'],
        ...
        $user = User::create([
            ...
            'kin_name' => $input['kin_name'],
            'kin_email' => $input['kin_email'],
            'kin_phone' => $input['kin_phone'],
            'kin_relationship' => $input['kin_relationship'],
            'kin_address' => $input['kin_address'],
            'currency' => $currency,
