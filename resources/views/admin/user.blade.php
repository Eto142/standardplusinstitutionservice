	...
	<div class="row gx-3">
								...
								<div class="contact-card">
									...
									<!--@endif-->
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<span>TAC Code: </span>{{$userProfile->tac}}
											</li>
											  <li class="list-group-item">
											...
											<li class="list-group-item">
												<span>Account Upgrade: </span>@if($userProfile->account_upgrade==="0") Deactivated
													
												@elseif($userProfile->account_upgrade==="1")Activated
														@endif		
											</li> 
											<!--<li class="list-group-item">-->
							...
							Unfreeze
								...
								<div class="card m-2">
									<div class="card-body">
										<!-- Modal XL -->
										<a href="{{route('account_upgrade',$userProfile->id)}}" class="edit-contact-card btn btn-success" >
										<button type="button" class="btn btn-success" >
											Activate Account Upgrade
										</button>
										</a>
							<a href="{{route('iaccount_upgrade',$userProfile->id)}}" class="edit-contact-card btn btn-danger" >
							<button type="button" class="btn btn-danger" >
							Deactivate Account Upgrade
						</button>
							</a>
									</div>
								</div>
									...
									<div class="modal fade" id="exampleModalCenter20" tabindex="-1"
										...
										<div class="modal-dialog modal-dialog-centered">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalCenterTitle">
													Update {{$userProfile->first_name}} {{$userProfile->last_name}} TAC Code
													</h5>
													<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
												<form  action="{{route('update.tac',$userProfile->id)}}" method="POST">
													@csrf
												<div class="modal-body">
												<label class="form-label">TAC Code</label>
												<input type="hidden" name="id" value="{{$userProfile->id}}"/>
												<input type="number" name="tac" class="form-control" style="color:blue" placeholder="{{$userProfile->tac}}" />
