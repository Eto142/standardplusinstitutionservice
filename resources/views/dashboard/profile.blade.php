                                ...
                                <div class="profile-info">
									...
									<div class="profile-details">
										...
										<div class="profile-email px-2 pt-2">
											...
											<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0">{{Auth::user()->kin_name}}</h4>
											<p>Next Of Kin</p>
										</div>
										
											<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0">{{Auth::user()->kin_email}}</h4>
											<p>Kin Email</p>
										</div>
										
											<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0">{{Auth::user()->kin_address}}</h4>
											<p>Kin Address</p>
										</div>
										
											<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0">{{Auth::user()->kin_phone}}</h4>
											<p>Kin Phone Number</p>
										</div>
										
											<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0">{{Auth::user()->kin_relationship}}</h4>
            ...
            <div class="modal-body">
				...
				@csrf
                    <div class="form-group">
                        <label for="idCard">Select Front ID Card:</label>
                        <input type="file" class="form-control" id="idCard" name="card" required>
                    </div>
                    <div class="form-group">
                        <label for="passport">Select Back ID Card:</label>
                                        ...
                                        <div class="tab-content">
                                        	<div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                            <h5 class="f-w-500">Next Of Kin <span class="pull-end">:</span></h5>
                                                        </div>
                                                        <div class="col-sm-9 col-7"><span>{{Auth::user()->kin_name}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
