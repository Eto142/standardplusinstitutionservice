...
<head>
    ...
    <meta name="author" content="Standard plus institution service">
    <meta name="robots" content="index, follow">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Standard plus institution service : ">
    <meta property="og:title" content="Standard plus institution service : ">
    <meta property="og:description" content="Standard plus institution service : ">
    <meta property="og:image" content="favicon.png">
    <meta name="format-detection" content="telephone=no">
    <title>Standard plus institution service - Dashboard</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('dashboard')}}" class="brand-logo">
                <img class="" src="{{asset('logo1.png')}}" alt="" width="95px" >
                <img class="logo-compact" src="{{asset('logo1.png')}}" alt="">
                <img class="brand-title" src="{{asset('logo1.png')}}" alt="" >
            </a>
