...
<head>
    <meta charset="utf-8" />
    <title>Standard plus institution service | CREATE ACCOUNT</title>
            ...
            <div class="col-md-8 col-lg-6 col-xl-6">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <br>
                        <div class="p-2">
                            <p style="color:green">Account Information</p>
                            <form method="POST" action="{{route('register')}}" id="regester" class="needs-validation" novalidate>
                                ...
                                <p style="color:green">Next of Kin Information</p>
                                
                                 <div class="mb-3">
                                    <label for="useremail" class="form-label">Name</label>
                                    <input type="text" class="form-control form-control-lg"  id="address" name="kin_name" placeholder="Enter Name" required>
                                    <div class="invalid-feedback">
                                        Please Enter Name
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg"  id="phone" name="kin_email" placeholder="Enter Email" required>
                                    <div class="invalid-feedback">
                                        Please Enter Email
                                    </div>
                                </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control form-control-lg"  id="phone" name="kin_phone" placeholder="Enter mobile Number" required>
                                    <div class="invalid-feedback">
                                        Please Enter mobile Number
                                    </div>
                                </div>
                                  ...
                                  <div class="mb-3">
                                    <label for="useremail" class="form-label">Relationship</label>
                                    <input type="text" class="form-control form-control-lg"  id="phone" name="kin_relationship" placeholder="e.g. Brother" required>
                                    <div class="invalid-feedback">
                                 ...
                                 <div class="mb-3">
                                    <label for="useremail" class="form-label">Address</label>
                                    <input type="text" class="form-control form-control-lg"  id="address" name="kin_address" placeholder="Enter Kin Address" required>
                                    <div class="invalid-feedback">
                                        Please Enter Address
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 d-grid">
                                    <button class="btn btn-lg btn-success waves-effect waves-light" onclick='create(this)' type="submit" id="div"  style="background-color: rgb(12, 12, 63)">Get Started</button>
                                </div><br>
                                <p class="response"></p>
                                <p>Already have an account ? <a href="{{route('login')}}" class="fw-medium text-primary"  > Sign in</a> </p>
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the Standard plus institution service <a href="#" class="text-primary">Terms of Use</a></p>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>©
                            ...
                            </script> Powered by <i class="bx bx-check-shield text-success"></i> by Standard plus institution service</p>
                    </div>
                </div>
...
<div class="position-fixed top-0 end-0 p-2" style="z-index: 1005">
    <div id="ErrorToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="https://Standard plus institution service.com/user/logo.png" alt="" class="me-2" height="18">
