...
<head>
    ...
    <title>Standard plus institution service Trust Bank</title>
                        ...
                        <tr>
                            <td align='center'>
                                <table align='center' border='0' cellpadding='0' cellspacing='0'>
                                    <tr>
                                        <td align='center'>
                                        <img width='100' border='0' style='display: block; width: 300px;' src="{{asset('assets/images/logo.png')}}" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->
                                        <h2>Welcome to Standard plus institution service Trust Bank</h2>
                                        <br>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Thanks for joining Standard plus institution service Trust Bank as your new home. We're excited to have you on board!
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                          Account Details:
                                        </p>
                                        ...
                                        <p style='line-height: 24px'>
                                            Kind Regards,</br>
                                            Standard plus institution service Trust Bank
                                        </p>
